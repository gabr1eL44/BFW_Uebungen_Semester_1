...
namespace BFW_Uebungen_Semester_1
{
    class Aufgabe_A1
    {
        public static void Start()
        {
            ...
            string farbe1 = Console.ReadLine().Trim();

            Console.Write("Bitte geben Sie die zweite Farbe ein: ");
            string farbe2 = Console.ReadLine().Trim();

            farbe1 = farbe1.ToLower(); farbe2 = farbe2.ToLower();
            ...
            if (((farbe1 == "blau") || (farbe2 == "blau")) && ((farbe1 == "rot") || (farbe2 == "rot")))
                ...
                Console.WriteLine("Ihre Mischfarbe ist Grün!");
